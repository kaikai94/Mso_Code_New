...
class CTileManager;
class CMHFile;
class CWayPointManager;//[自动寻路][By:慌张的油条][QQ:112582793][2018/9/15]
...
class CMHMap  
{
	...
	std::map<DWORD,std::string> m_TownInfo;
...
public:
	...
	//[解决多线路自动回城黑屏bug][By:十里坡剑神][QQ:112582793][2018/4/4]
	void LoadTownMapInfo();
	BOOL IsTownMap(DWORD wMapNum);
public://[自动寻路][By:慌张的油条][QQ:112582793][2018/9/15]
...
public:
	...
	//[路径显示][By:慌张的油条][QQ:112582793][2018/9/15]
	void RenderTileData_Debug();
	void RenderOneTile(const VECTOR3& p_TileOriPos,DWORD p_Color);
