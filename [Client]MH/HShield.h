...
int __stdcall _AhnHS_MakeAckMsg (unsigned char *pbyReqMsg,unsigned char *pbyAckMsg);
 ...
 *
 */
int __stdcall _AhnHS_MakeGuidAckMsg(unsigned char *pbyGuidReqMsg,unsigned char *pbyGuidAckMsg);
