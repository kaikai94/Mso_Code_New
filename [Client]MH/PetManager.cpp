	...
	case MP_PET_STATEINFO:
		{
			...
			//if (pmsg->dwData3) //[³èÎïËµ»°ÐÅÏ¢ÆÁ±Î][BY:Ê®ÀïÆÂ½£Éñ][QQ:112582793][2019-9-4][15:35:45]
			//{
...
WORD CPetManager::GetPetSummon()
{
	if(!m_pCurSummonPet)
		return 0;//µ±Ç°Ã»ÕÙ»½³èÎï·µ»Ø100²»´¥·¢Î¹Ñø
	else
		return 	((m_pCurSummonPet->GetMaxStamina()-m_pCurSummonPet->m_PetTotalInfo.PetStamina)/100)*100;
}
