...
protected:
	...
	std::map<DWORD,CQuestString*> m_QuestStringTable;
...
public:
	...
	CQuestString* GetQuestString(DWORD key);
	void	Release();
	// script
	...
	void	SendNpcTalkEvent( DWORD dwNpcIdx, DWORD dwNpcScriptIdx,DWORD dwNpcID=0 );
