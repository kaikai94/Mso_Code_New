...
//			CHATMGR->AddMsg( CTC_SYSMSG, "[살생부]답변이 틀려 접을 끊습니다." );
...
//			CHATMGR->AddMsg( CTC_SYSMSG, "[살생부]답변 제한시간이 지나 접을 끊습니다." );
...
//			CHATMGR->AddMsg( CTC_SYSMSG, "[살생부]선택한 대상이 답변을 맞추지 못하여 접이 종료되었습니다." );
		}
		break;
