...
#include "cSetingInfoDlg.h"		//[…Ë÷√–≈œ¢≤Èø¥ΩÁ√Ê][By: Æ¿Ô∆¬Ω£…Ò][QQ:112582793][2018/3/10]
//////////////////////////////////////////////////////////////////////
...
void CSiegeWarMgr::NetworkMsgParse( BYTE Protocol,void* pMsg )
{
	...
	case MP_SIEGEWAR_DEFENCE_REGIST_NACK:
		...
		break;
	case MP_SIEGEWAR_PROPOSALLIST_ACK:	// ºˆº∫ ¬¸ø© ∏ÆΩ∫∆Æ
		{
	...
	case MP_SIEGEWAR_PROPOSALLIST_NACK:
		...
		break;
	case MP_SIEGEWAR_GUILDLIST_ACK:		// ∞¯,ºˆº∫ ∏ÆΩ∫∆Æ
		{
	...
	case MP_SIEGEWAR_GUILDLIST_NACK:
		...
		break;
	case MP_SIEGEWAR_TAXRATE_ACK:		// ºº¿≤∫Ø∞Ê
		{
			MSGBASE* pmsg = (MSGBASE*)pMsg;
		}
		break;
	...
	case MP_SIEGEWAR_CHANGESTATE:
		{
			...
			GAMEIN->GetSetingInfoDlg()->SetSiegeWarInfo(pmsg->dwData);
		}
		break;
	...
	case MP_SIEGEWAR_RESTRAINT_OFF:
		...
		break;
	case MP_SIEGEWAR_BATTLEINFO:			// ∞¯º∫ º∫∞¯»ƒ ¡§∫∏∏¶ ¥ŸΩ√ πﬁ¿ª∂ß
		{
...
//			case 1:
//			case 2:
//				CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg(1676) ); //º∫¡÷∏∏ º∫πÆ¿ª ∞≠»≠«“ ºˆ ¿÷Ω¿¥œ¥Ÿ.
//				break;
//			case 3:
//				CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg(117) ); //µ∑¿Ã ∫Œ¡∑«’¥œ¥Ÿ.	
//				break;
//			case 4:
//				CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg(1677) ); //º∫πÆ ∞≠»≠ø° Ω«∆–«œø¥Ω¿¥œ¥Ÿ.
//				break;
//			case 5:
//				CHATMGR->AddMsg( CTC_SYSMSG, CHATMGR->GetChatMsg(1678) ); //º∫πÆ¿ª ∞≠»≠«“ ºˆ ¿÷¥¬ ±‚∞£¿Ã æ∆¥’¥œ¥Ÿ.
//				break;
//			}
//#else
			switch( pmsg->dwData )
