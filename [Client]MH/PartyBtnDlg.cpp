...
{
	m_bSetTopOnActive = FALSE;	//KES脙脽掳隆;
...
#ifdef _XDYY_
	//[小队语音][By:十里坡剑神][QQ:112582793][2019/3/22][0:38:46]
	m_pVoiceBtn =  (cButton*)GetWindowForID(OV_TEAMVOICE_SET_BTN);
	cImage imgToolTip;
	SCRIPTMGR->GetImage( 63, &imgToolTip, PFT_HARDPATH );
	m_pVoiceBtn->SetToolTip(CHATMGR->GetChatMsg(2335),RGBA_MAKE(255, 255, 255, 255),&imgToolTip,TTCLR_ITEM_CANEQUIP);
#endif
}
