...
private:
	...
	protected:
		DWORD				m_dwDataNum;		//[链表中当前元素数量][BY:十里坡剑神][QQ:112582793][2019-6-28][23:38:14]

		DWORD				m_dwMaxBucketNum;	//[链表中最大存储元素数量][BY:十里坡剑神][QQ:112582793][2019-6-28][23:38:26]
		BUCKET**			m_ppBucketTable;	//[元素表][BY:十里坡剑神][QQ:112582793][2019-6-28][23:38:39]
		LIST*				m_pListHead;		//[元素表头节点][BY:十里坡剑神][QQ:112582793][2019-6-28][23:39:02]
		LIST*				m_pListTail;		//[元素表尾巴][BY:十里坡剑神][QQ:112582793][2019-6-28][23:39:11]
		LIST*				m_pListCur;			//[元素表当前节点指针][BY:十里坡剑神][QQ:112582793][2019-6-28][23:39:20]
		
		BUCKET*				m_pCurBucket;		//[元素表当前元素][BY:十里坡剑神][QQ:112582793][2019-6-28][23:39:33]
		BUCKET*				m_pLastBucket;		//[元素表最后一个元素][BY:十里坡剑神][QQ:112582793][2019-6-28][23:39:49]
