...
typedef struct tagUSERINFO
{
	...
	WORD    wServerNum;        
	//[附加洛阳城主信息][By:胡汉三][QQ:112582793][2018/2/23]
	BOOL    bIsSiegeWarMaster;
	DWORD	dwSWMasterID;
	//[账号注册变量定义][By:胡汉三][QQ:112582793][2017/11/23]
	char   reUserID[20];
	char   rePwd[20];
	char   reTel[20];
	char   reEmail[50];
...
{
	DWORD m_MaxUserCount;	//辑滚砒俊 汲沥等 MaxUser
	DWORD m_dwUserCount;	//泅犁 Distribute俊 立加等 蜡历荐

	DWORD m_addCount;		//醚 立加等 蜡历荐
