...
public:
	...
	BOOL	CheckPower( DWORD dwConnectionIndex, WORD wPower );
	WORD	GetPower( DWORD dwConnectionIndex );

protected:
	OPERID		m_IDArray[MAX_IPARRAY];

public:
	void		RegistID( DWORD dwConnectionIdx, DWORD dwIdx, char* pName, WORD wPower );
