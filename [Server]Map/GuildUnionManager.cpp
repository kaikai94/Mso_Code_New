...
DWORD CGuildUnionManager::CheckEntryTime( DWORD dwGuildIdx )
{
	...
	//[Í¬ÃË´´½¨ÏÞÖÆÊ±¼ä,·µ»Ø0Ôò¿É´´½¨][By:Ê®ÀïÆÂ½£Éñ][QQ:112582793][2017/12/7]
	//return pTime->value;
	return 0;
}
...
CGuildUnion* CGuildUnionManager::GetUnionInfo(DWORD dwUnionIdx)
{
	CGuildUnion* pInfo = NULL;
	pInfo = m_GuildUnionTable.GetData(dwUnionIdx);
	return pInfo;
}
