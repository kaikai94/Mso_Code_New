	...
	case eGTState_BeforeRegist:
		{
			...
			if( st.wHour < m_RegistTime[0].Hour )				return;	
	...
	case eGTState_Regist:
		{
			...
			if( st.wHour < m_RegistTime[1].Hour )				return;	
...
void CGuildTournamentMgr::GTouRnament_Registcount(void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_Regist_Syn(void* pMsg)
{
	if (FALSE == g_pServerSystem->GetMap()->IsMapKind(eTournament))
	{
		MSGBASE* pmsg = (MSGBASE*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Regist_Ack(void* pMsg)
{
	MSG_DWORD3* pmsg = (MSG_DWORD3*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Regist_Nack(void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_RegistCancel_Syn(void* pMsg)
{
	MSGBASE* pmsg = (MSGBASE*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_MoveToBattleMap_Syn(void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_BattleJoin_Syn(DWORD dwConnectionIndex, void* pMsg)
{
	...
	//[¹ýÍ¼ºÚÆÁÐÞ¸´][By:Ê®ÀïÆÂ½£Éñ][QQ:112582793][2017/12/5]
...
void CGuildTournamentMgr::GTouRnament_ObServerJion_Syn(DWORD dwConnectionIndex, void* pMsg)
{
	SEND_BATTLEJOIN_INFO* pmsg = (SEND_BATTLEJOIN_INFO*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Leave_Syn(DWORD dwConnectionIndex, void* pMsg)
{
	MSG_DWORD3* pmsg = (MSG_DWORD3*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_StandingInfo_Syn(DWORD dwConnectionIndex, void* pMsg)
{
	MSG_DWORD2* pmsg = (MSG_DWORD2*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_BattleInfo_Syn(void* pMsg)
{
	MSGBASE* pmsg = (MSGBASE*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_ObServer_Exit(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_RegistAck(void* pMsg)
{
	MSG_DWORD2* pmsg = (MSG_DWORD2*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Regist_Cancel(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Regist_StateChange(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
	m_TournamentState = pmsg->dwData;
}
void CGuildTournamentMgr::GTouRnament_CurTournamentChange(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_BattleInfo(void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_BatEnd_ToMap(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
	//if( g_pServerSystem->GetMapNum() == GTMAPNUM )		return;
	if (TRUE == g_pServerSystem->GetMap()->IsMapKind(eTournament))	return;
...
void CGuildTournamentMgr::GTouRnament_Notify_WinLos(void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_Win(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
	//if( g_pServerSystem->GetMapNum() == GTMAPNUM )		return;
	if (TRUE == g_pServerSystem->GetMap()->IsMapKind(eTournament))	return;
...
void CGuildTournamentMgr::GTouRnament_EndBattle(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
	//if( g_pServerSystem->GetMapNum() == GTMAPNUM )		return;
	if (TRUE == g_pServerSystem->GetMap()->IsMapKind(eTournament))	return;
...
void CGuildTournamentMgr::GTouRnament_Event_Start(DWORD dwConnectionIndex, void* pMsg)
{
...
void CGuildTournamentMgr::GTouRnament_Event_Satrt_Ack(void* pMsg)
{
	MSG_DWORD3* pmsg = (MSG_DWORD3*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_Cheat(DWORD dwConnectionIndex, void* pMsg)
{
	MSG_DWORD2* pmsg = (MSG_DWORD2*)pMsg;
...
void CGuildTournamentMgr::GTouRnament_FlagChange(void* pMsg)
{
	MSG_DWORD* pmsg = (MSG_DWORD*)pMsg;
...
void CGuildTournamentMgr::NetworkMsgParse( DWORD dwConnectionIndex, BYTE Protocol,void* pMsg )
{
	switch( Protocol )
	{
	case MP_GTOURNAMENT_REGISTCOUNT:			GTouRnament_Registcount(pMsg);			break;
	case MP_GTOURNAMENT_REGIST_SYN:				GTouRnament_Regist_Syn(pMsg);			break;
	case MP_GTOURNAMENT_REGIST_ACK:				GTouRnament_Regist_Ack(pMsg);			break;
	case MP_GTOURNAMENT_REGIST_NACK:			GTouRnament_Regist_Nack(pMsg);			break;
	case MP_GTOURNAMENT_REGISTCANCEL_SYN:		GTouRnament_RegistCancel_Syn(pMsg);		break;
	case MP_GTOURNAMENT_MOVETOBATTLEMAP_SYN:	GTouRnament_MoveToBattleMap_Syn(pMsg);	break;
	case MP_GTOURNAMENT_BATTLEJOIN_SYN:			GTouRnament_BattleJoin_Syn(dwConnectionIndex, pMsg);		break;
	case MP_GTOURNAMENT_OBSERVERJOIN_SYN:		GTouRnament_ObServerJion_Syn(dwConnectionIndex, pMsg);		break;
	case MP_GTOURNAMENT_LEAVE_SYN:				GTouRnament_Leave_Syn(dwConnectionIndex, pMsg);				break;
	case MP_GTOURNAMENT_STANDINGINFO_SYN:		GTouRnament_StandingInfo_Syn(dwConnectionIndex, pMsg);		break;
	case MP_GTOURNAMENT_BATTLEINFO_SYN:			GTouRnament_BattleInfo_Syn(pMsg);		break;
	case MP_GTOURNAMENT_OBSERVER_EXIT:			GTouRnament_ObServer_Exit(pMsg);		break;
	case MP_GTOURNAMENT_REGISTACK:				GTouRnament_RegistAck(pMsg);			break;
	case MP_GTOURNAMENT_REGISTCANCEL:			GTouRnament_Regist_Cancel(pMsg);		break;
	case MP_GTOURNAMENT_STATECHANGE:			GTouRnament_Regist_StateChange(pMsg);	break;
	case MP_GTOURNAMENT_CURTOURNAMENTCHANGE:	GTouRnament_CurTournamentChange(pMsg);	break;
	case MP_GTOURNAMENT_BATTLEINFO:				GTouRnament_BattleInfo(pMsg);			break;
	case MP_GTOURNAMENT_BATEND_TOMAP:			GTouRnament_BatEnd_ToMap(pMsg);			break;
	case MP_GTOURNAMENT_NOTIFY_WINLOSE:			GTouRnament_Notify_WinLos(pMsg);		break;
	case MP_GTOURNAMENT_WIN:					GTouRnament_Win(pMsg);					break;
	case MP_GTOURNAMENT_ENDBATTLE:				GTouRnament_EndBattle(pMsg);			break;
/*	case MP_GTOURNAMENT_LOSE:
		...
		break;*/
	case MP_GTOURNAMENT_EVENT_START:				GTouRnament_Event_Start(dwConnectionIndex, pMsg);			break;
	case MP_GTOURNAMENT_EVENT_END:					ResetEvent();												break;
	case MP_GTOURNAMENT_EVENT_START_ACK:			GTouRnament_Event_Satrt_Ack(pMsg);							break;
	case MP_GTOURNAMENT_CHEAT:						GTouRnament_Cheat(dwConnectionIndex, pMsg);					break;
	case MP_GTOURNAMENT_FLAGCHANGE:					GTouRnament_FlagChange(pMsg);								break;
	default:
		break;
	}
}
