...
{//[经验初步计算][By:十里坡剑神][QQ:112582793][2017/12/10]
	float Exp = 0.f;
	if( level_gap < -8 )	
	{
...
{//[爆击概率计算][By:十里坡剑神][QQ:112582793][2017/12/10]
	int nRand = rand() % 100;
...
{//[物理攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
...
//	if(bCritical)	//[暴击计算屏蔽][By:十里坡剑神][QQ:112582793][2019/3/31][14:37:14]
//	{
...
{//[属性攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
	DWORD MinV=0,MaxV=0;
...
//		MaxV = (MaxLVV * ((dS+200)/200)*((dS+1000)/500)+dS)*0.6;
	...
	//MinV = (DWORD)(AttUp + MinV);
	//MaxV = (DWORD)(AttUp + MaxV);
	//[法师伤害附加值][By:十里坡剑神][QQ:112582793][2018/10/11]
//#endif
...
{//[怪物物理攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
...
{//[怪物属性攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
...
{//[泰坦物理攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
	double physicalAttackPower = 0;
	DWORD minVal,maxVal;
...
{//[泰坦属性攻击力计算][By:十里坡剑神][QQ:112582793][2017/12/10]
	DWORD MinV=0,MaxV=0;
...
{//[物理防御力][By:十里坡剑神][QQ:112582793][2017/12/10]
	...
	if( pObject->GetObjectKind() == eObjectKind_Player )
	{
		...
		if( ((CPlayer*)pObject)->GetPartyIdx() )
		{
			...
			if( pParty )
			{
				...
				if( count && gPartyEvent[ePartyEvent_DefenceRate].Rate[count-1] )//[组队防御力加成计算][By:十里坡剑神][QQ:112582793][2018/4/22]
