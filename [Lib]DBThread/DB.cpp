...
CDB::CDB(DESC_DBTHREAD* pDesc)
{
	...
	m_dwMessageMaxSize		=	pDesc->dwMessageMaxSize;	
	m_dwNumofMessage		=	pDesc->dwNumofMessage;			
	m_dwResultMaxSize		=	pDesc->dwResultMaxSize;		
	m_dwNumofResult			=	pDesc->dwNumofResult;			
	m_dwSizeofStack			=	pDesc->dwSizeofStack;			
...
{
	strcpy_s(m_pDBAdmin->szDBName, sizeof(m_pDBAdmin->szDBName), Dbname);
	strcpy_s(m_pDBAdmin->szID, sizeof(m_pDBAdmin->szID), szID);
	strcpy_s(m_pDBAdmin->szPW, sizeof(m_pDBAdmin->szPW), szPassword);
	strcpy_s(m_pDBClient->szDBName, sizeof(m_pDBClient->szDBName), DbnameC);
	strcpy_s(m_pDBClient->szID, sizeof(m_pDBClient->szID), szIDC);
	strcpy_s(m_pDBClient->szPW, sizeof(m_pDBClient->szPW), szPasswordC);
...
LPDBCON	CDB::MakeNewConnection(LPSTR lpDbName, LPSTR lpID, LPSTR lpPW)
{
	...
	strcpy_s(lpTemp->szDBName, sizeof(lpTemp->szDBName), lpDbName);
	strcpy_s(lpTemp->szID, sizeof(lpTemp->szID), lpID);
	strcpy_s(lpTemp->szPW, sizeof(lpTemp->szPW), lpPW);
...
BOOL CDB::InsertRecord(LPDBCON pCon, LPSTR szTableName, LPVOID lpCol, LPVOID lpValue, BYTE bNumData)
{
	...
	case 1:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s) VALUES ('%s')", szTableName,pCol->Data1, pValue->Data1);
		break;
	}
	case 2:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s,%s) VALUES ('%s', '%s')", szTableName, pCol->Data1, pCol->Data2, pValue->Data1, pValue->Data2);
		break;
	}
	case 3:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s ) VALUES ('%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pValue->Data1, pValue->Data2, pValue->Data3);
		break;	
	}
	case 4:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s ) VALUES ('%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4);
		break;	
	}
	case 5:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s, %s ) VALUES ('%s','%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pCol->Data5, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4, pValue->Data5);
		break;	
	}
	case 6:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s, %s, %s ) VALUES ('%s','%s','%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pCol->Data5, pCol->Data6, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4, pValue->Data5, pValue->Data6);
		break;	
	}
	case 7:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s, %s, %s, %s) VALUES ('%s','%s','%s','%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pCol->Data5, pCol->Data6, pCol->Data7, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4, pValue->Data5, pValue->Data6, pValue->Data7);
		break;	
	}
	case 8:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s, %s, %s, %s, %s) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pCol->Data5, pCol->Data6, pCol->Data7, pCol->Data8, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4, pValue->Data5, pValue->Data6, pValue->Data7, pValue->Data8);
		break;	
	}
	case 9:
	{
		...
		sprintf_s(Buffer, "INSERT INTO %s (%s, %s, %s, %s, %s, %s, %s, %s,%s) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s')", szTableName, pCol->Data1, pCol->Data2, pCol->Data3, pCol->Data4, pCol->Data5, pCol->Data6, pCol->Data7, pCol->Data8, pCol->Data9, pValue->Data1, pValue->Data2, pValue->Data3, pValue->Data4, pValue->Data5, pValue->Data6, pValue->Data7, pValue->Data8, pValue->Data9);
		break;	
	}
...
BOOL	CDB::DeleteRecord(LPDBCON pCon, LPSTR szTableName, LPSTR lpCol, LPSTR lpValue)
{
	...
	sprintf_s(Buffer, "DELETE FROM %s where %s = '%s'", szTableName, lpCol, lpValue);
...
BOOL	CDB::UpdateRecord(LPDBCON pCon, LPSTR szTableName, LPSTR lpCol, LPSTR lpValue, LPSTR DestCol, LPSTR	DestValue)
{
	...
	char Buffer[MAX_LENGTH_QUERY];
	if (lpCol == NULL)
		sprintf_s(Buffer, "Update %s set %s = '%s'", szTableName, DestCol, DestValue);
	else
		sprintf_s(Buffer, "Update %s set %s = '%s' where %s = '%s'", szTableName, DestCol, DestValue, lpCol, lpValue);
...
BOOL	CDB::ExcuteIUDForProcedure(LPDBCON pCon, LPSTR szQuery)
{
	...
	char Buffer[MAX_LENGTH_QUERY];
	strcpy_s(Buffer,sizeof(Buffer),szQuery);
...
BOOL	CDB::Login(LPDBCON pCon, LPSTR szTableName, LPSTR pColID, LPSTR pColPW, LPSTR pID, LPSTR pPW, LPSTR pRetCol, LPVOID pRetValue, int iLength, SQLSMALLINT sqlType)
{
	...
	sprintf_s(Buffer, "SELECT  %s FROM %s where %s = '%s' AND %s = '%s'", pRetCol, szTableName, pColID, pID, pColPW, pPW);
...
BOOL	CDB::SimpleLogin(LPDBCON pCon,LPSTR pID, LPSTR pPW, LPVOID pRetValue)
{
	...
	sprintf_s(Buffer, "SELECT  %s FROM %s where %s = '%s' AND %s = '%s'", m_szDefault_User_guid, m_szDefault_User_table, m_szDefault_User_account, pID, m_szDefault_User_pw, pPW);
...
LPQUERY FAR PASCAL CDB::SingleQuery(LPDBCON pCon, LPSTR szTable, DWORD dwValue, LPSTR lpCol, SQLSMALLINT sqltype)
{
	...
	if (lpCol == NULL || *lpCol == 0)
		sprintf_s(szBuffer, "select * from %s where IDENTITYCOL = '%d' ", szTable, dwValue);
	else sprintf_s(szBuffer, "select %s from %s where IDENTITYCOL = '%d' ", lpCol, szTable, dwValue);
